...
const ZONE_META = {
  ...
  'COMMERCIAL/MIXED USE':                                  { color: '#c97af7', label: 'FALLON ROAD MIXED USE',        proposedLabel: 'MIXED USE', hideFromExistingLegend: true, definition: 'Commercial, office, light industrial uses, and housing along Fallon Road', proposedDefinition: 'Mixed for commercial, office, housing, and light industrial uses' },
